 ...
 */
export declare function SafeAreaTopScrim({ variant, backgroundColor, zIndex, className, style, ...props }: SafeAreaTopScrimProps): import("react").DetailedReactHTMLElement<{
